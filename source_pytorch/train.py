...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type = int, default = 3, metavar = 'IN', 
                        help = 'number of input features to the model (default: 3)')
    parser.add_argument('--hidden_dim', type = int, default = 15, metavar = 'H', 
                        help = 'number of hidden layers in the model (default: 15)')
